...
import com.fr3gu.letsmodreboot.entity.EntityBomb;
...
public class ModEntities {
    ...
    public static void init() {
        ...
        EntityRegistry.registerModEntity(EntitySpaceship.class, "EntitySpaceship", 1, LetsModReboot.instance, 80, 3, false);
        EntityRegistry.registerModEntity(EntityBomb.class, "EntityBomb", 2, LetsModReboot.instance, 80, 3, true);
