...
public class ModelSpaceship extends ModelBase {
	...
	public ModelSpaceship() {
		...
		back.rotateAngleX = getRadius();
		back.rotateAngleY = getRadius();
    	...
    	front.rotateAngleX = getRadius();   	
    	front.rotateAngleY = getRadius();   
    	...
    	window.rotateAngleX = getRadius();
    	window.rotateAngleY = getRadius();
	}
